...
<head>
    ...
    <title>PeindiaNews - News Protal</title>
...
<body>
    ...
    <div id='preloader'>
        <div class='loader'>
            <img src="img/logo/loader.png" width="200" alt="Loader image">
        </div>
    </div>
    <!-- Preloader -->
        ...
        <div class="container">
            <div class="featured-wrap">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="post-carousel owl-carousel">
                        <div class="featured-post" style="background-image: url(img/slider-post-2.1.jpg);">
                            <div class="post-info">
                        ...
                        <div class="featured-post" style="background-image: url(img/slider-post-2.2.jpg);">
                            <div class="post-info">
                                <a href="#" class="cat-name tt-u">Sports</a>
                                <h3 class="fw-6 fz-16"><a href="#" class="text-white">Improve Your Health And Stamina With Cycling.</a></h3>
                            </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="top-wrap mb-10">
                        <div class="post-carousel owl-carousel">
                            ...
                            <div class="featured-post" style="background-image: url(img/slider-post-3.1.jpg);">
                                <div class="post-info">
                                    <a href="#" class="cat-name tt-u">Indian Army</a>
                                    <h3 class="fw-6 fz-16"><a href="#" class="text-white">An Army or Ground Force is a Fighting Force That Fights Primarily On Land.</a></h3>
                                </div>
                    ...
                    <div class="bottom-wrap">
                        <div class="post-carousel owl-carousel">
                            <div class="featured-post" style="background-image: url(img/slider-post-4.0.jpg);">
                                <div class="post-info">
                            ...
                            <div class="featured-post" style="background-image: url(img/slider-post-4.1.jpg);">
                                <div class="post-info">
                                    <a href="#" class="cat-name tt-u">World</a>
                                    <h3 class="fw-6 fz-16"><a href="#" class="text-white">Alex Helis Confirms Mystery Pop Singer On New Music Album.</a></h3>
                                </div>
